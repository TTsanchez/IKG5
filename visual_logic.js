...
anim2 = 0;
registerOnClick(['GROUP', 'Kn0'], false, false, [0,1,2], function() {
  anim = 0;

  operateAnimation('PAUSE', 'Steel_Cyl', null, null, 'AUTO', 1,
          function() {}, false);


  operateAnimation('PAUSE', 'Cylinder.001', null, null, 'AUTO', 1,
          function() {}, false);


  operateAnimation('PLAY', 'Kn0', null, null, 'LoopOnce', 1,
          function() {}, false);

      setObjTransform('Kn1', false, 'position', ['', '', 0.096733], false);
  setObjTransform('Kn2', false, 'position', ['', '', 0.096733], false);
  synthSound('PROGRAM', 0, 60, 100, 0, 0, 117);
  synthSound('NOTE_ON', 0, getNoteNumber(0, 2), 30, 0, 0, 0);
}, function() {});
registerOnClick(['GROUP', 'Kn1'], false, false, [0,1,2], function() {
  anim = 1;

  operateAnimation('SET_SPEED', 'Steel_Cyl', null, null, 'AUTO', 1,
          function() {}, false);

      if (0 == getAnimationFrame('Steel_Cyl')) {

    operateAnimation('PLAY', 'Steel_Cyl', null, null, 'AUTO', 1,
            function() {}, false);

        } else {

    operateAnimation('RESUME', 'Steel_Cyl', null, null, 'AUTO', 1,
            function() {}, false);

        }
  setObjTransform('Kn1', false, 'position', ['', '', 0.086733], false);
  setObjTransform('Kn2', false, 'position', ['', '', 0.096733], false);
  if (anim2) {

    operateAnimation('RESUME', 'Cylinder.001', null, null, 'AUTO', 1,
            function() {}, false);

        }
  synthSound('PROGRAM', 0, 60, 100, 0, 0, 117);
  synthSound('NOTE_ON', 0, getNoteNumber(0, 3), 30, 0, 0, 0);
}, function() {});
registerOnClick(['GROUP', 'Kn2'], false, false, [0,1,2], function() {
  anim = 1;

  operateAnimation('SET_SPEED', 'Steel_Cyl', null, null, 'AUTO', 2,
          function() {}, false);
  ...
  setObjTransform('Kn2', false, 'position', ['', '', 0.086733], false);
  setObjTransform('Kn1', false, 'position', ['', '', 0.096733], false);
  if (anim2) {
  ...
  synthSound('PROGRAM', 0, 60, 100, 0, 0, 117);
  synthSound('NOTE_ON', 0, getNoteNumber(0, 4), 30, 0, 0, 0);
}, function() {});
registerOnClick(['GROUP', 'KnR'], false, false, [0,1,2], function() {
  synthSound('PROGRAM', 0, 60, 100, 0, 0, 117);
  if (anim2) {
    anim2 = 0;
    setObjTransform('KnPov', false, 'position', ['', '', 0.096733], false);
    synthSound('NOTE_ON', 0, getNoteNumber(0, 0), 30, 0, 0, 0);
  } else {
    anim2 = 1;
    setObjTransform('KnPov', false, 'position', ['', '', 0.086733], false);
    synthSound('NOTE_ON', 0, getNoteNumber(0, 1), 30, 0, 0, 0);
  }
  if (anim && !isAnimationPlaying('Cylinder.001')) {
    if (0 == getAnimationFrame('Cylinder.001')) {

      operateAnimation('PLAY', 'Cylinder.001', null, null, 'AUTO', 1,
              function() {}, false);
...
eventHTMLElem('click', 'orange', false, function(event) {
  assignMat('osnova', 'Orange');
  assignMat('Bashnya', 'Orange');
  assignMat('Okontovka', 'Orange');
  assignMat('Pl_Cyl', 'Orange');
});
eventHTMLElem('click', 'grey', false, function(event) {
  assignMat('osnova', 'Grey');
  assignMat('Bashnya', 'Grey');
  assignMat('Okontovka', 'Grey');
  assignMat('Pl_Cyl', 'Grey');
});
eventHTMLElem('click', 'black', false, function(event) {
  assignMat('osnova', 'Black');
  assignMat('Bashnya', 'Black');
  assignMat('Okontovka', 'Black');
  assignMat('Pl_Cyl', 'Black');
});
eventHTMLElem('click', 'green', false, function(event) {
  assignMat('osnova', 'green');
  assignMat('Bashnya', 'green');
  assignMat('Okontovka', 'green');
  assignMat('Pl_Cyl', 'green');
});
eventHTMLElem('click', 'purple', false, function(event) {
  assignMat('osnova', 'Purple');
  assignMat('Bashnya', 'Purple');
  assignMat('Okontovka', 'Purple');
  assignMat('Pl_Cyl', 'Purple');
});

eventHTMLElem('click', 'yellow', false, function(event) {
  assignMat('Lopast1', 'light-yellow');
  assignMat('Lopast1.001', 'light-yellow');
  assignMat('Lopast1.002', 'light-yellow');
});
eventHTMLElem('click', 'black2', false, function(event) {
  assignMat('Lopast1', 'Black');
  assignMat('Lopast1.001', 'Black');
  assignMat('Lopast1.002', 'Black');
});
eventHTMLElem('click', 'steel', false, function(event) {
  assignMat('Lopast1', 'Steel');
  assignMat('Lopast1.001', 'Steel');
  assignMat('Lopast1.002', 'Steel');
});
eventHTMLElem('click', 'steel2', false, function(event) {
  assignMat('Lopast1', 'steel_top');
  assignMat('Lopast1.001', 'steel_top');
  assignMat('Lopast1.002', 'steel_top');
});
eventHTMLElem('click', 'orange2', false, function(event) {
  assignMat('Lopast1', 'Orange');
  assignMat('Lopast1.001', 'Orange');
  assignMat('Lopast1.002', 'Orange');
});

eventHTMLElem('click', 'steel2.1', false, function(event) {
  assignMat('Reshetka', 'Steel');
  assignMat('Face_Cyl', 'Steel');
  assignMat('Steel_Cyl', 'Steel');
  assignMat('Cube', 'Steel');
});
eventHTMLElem('click', 'steel2.2', false, function(event) {
  assignMat('Reshetka', 'steel_top');
  assignMat('Face_Cyl', 'steel_top');
  assignMat('Steel_Cyl', 'steel_top');
  assignMat('Cube', 'steel_top');
});
eventHTMLElem('click', 'orange_me', false, function(event) {
  assignMat('Reshetka', 'Orange_Metal');
  assignMat('Face_Cyl', 'Orange_Metal');
  assignMat('Steel_Cyl', 'Orange_Metal');
  assignMat('Cube', 'Orange_Metal');
});

eventHTMLElem('click', 'orange3', false, function(event) {
  assignMat('Kn0', 'Orange');
  assignMat('Kn1', 'Orange');
  assignMat('Kn2', 'Orange');
  assignMat('KnPov', 'Orange');
});
eventHTMLElem('click', 'yellow2', false, function(event) {
  assignMat('Kn0', 'light-yellow');
  assignMat('Kn1', 'light-yellow');
  assignMat('Kn2', 'light-yellow');
  assignMat('KnPov', 'light-yellow');
});
eventHTMLElem('click', 'white', false, function(event) {
  assignMat('Kn0', 'White');
  assignMat('Kn1', 'White');
  assignMat('Kn2', 'White');
  assignMat('KnPov', 'White');
});
eventHTMLElem('click', 'purple2', false, function(event) {
  assignMat('Kn0', 'Purple');
  assignMat('Kn1', 'Purple');
  assignMat('Kn2', 'Purple');
  assignMat('KnPov', 'Purple');
});
...
eventHTMLElem('click', 'osnova', false, function(event) {
  tweenCamera('Spot', 'osnova', 1, function() {}, 0);
  setHTMLElemStyle('display', 'block', 'vibor1', false);
  setHTMLElemStyle('display', 'none', 'vibor2', false);
  setHTMLElemStyle('display', 'none', 'vibor3', false);
  setHTMLElemStyle('display', 'none', 'vibor4', false);
});
eventHTMLElem('click', 'lopasti', false, function(event) {
  tweenCamera('Spot', 'Face_Cyl', 1, function() {}, 0);
  setHTMLElemStyle('display', 'block', 'vibor2', false);
  setHTMLElemStyle('display', 'none', 'vibor1', false);
  setHTMLElemStyle('display', 'none', 'vibor3', false);
  setHTMLElemStyle('display', 'none', 'vibor4', false);
});
eventHTMLElem('click', 'stal', false, function(event) {
  tweenCamera('Spot', 'Face_Cyl', 1, function() {}, 0);
  setHTMLElemStyle('display', 'block', 'vibor3', false);
  setHTMLElemStyle('display', 'none', 'vibor1', false);
  setHTMLElemStyle('display', 'none', 'vibor2', false);
  setHTMLElemStyle('display', 'none', 'vibor4', false);
});
eventHTMLElem('click', 'knopki', false, function(event) {
  tweenCamera('cam1', 'Cube', 1, function() {}, 0);
  setHTMLElemStyle('display', 'block', 'vibor4', false);
  setHTMLElemStyle('display', 'none', 'vibor1', false);
  setHTMLElemStyle('display', 'none', 'vibor2', false);
  setHTMLElemStyle('display', 'none', 'vibor3', false);
});
...
eventHTMLElem('click', 'pause', false, function(event) {
...
eventHTMLElem('click', 'stop', false, function(event) {
  ...
  operateAnimation('STOP', 'Steel_Cyl', null, null, 'AUTO', 1,
          function() {}, false);


  operateAnimation('STOP', 'Kn0', null, null, 'AUTO', 1,
          function() {}, false);
...
eventHTMLElem('click', 'mat', false, function(event) {
  if (mat_on) {
    mat_on = 0;
    setHTMLElemStyle('display', 'none', 'menu', false);
  } else {
    mat_on = 1;
    setHTMLElemStyle('display', 'block', 'menu', false);
  }
});
